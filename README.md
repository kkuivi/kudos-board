...
Deployed Application (**required**): [Kudos Board Deployed Site](https://kudos-board-frontend-sb4h.onrender.com/)
...
- [X] **Add New Board**
  ...
  - [X]x When creating a new board, users can specify the:
    - [X] Title (required)
    - [X] Category (required)
    - [X] Author (optional)
...
https://www.loom.com/share/23996b9afbb34784872c90139c43230a?sid=75163f90-0c5b-4fc2-b643-75d57be1a201
...
I had no time to work on this properly due to other commitments
